 ...
 * object from the server — preventing localStorage tampering from
 * granting access to unauthorized tabs.
 *
 * If the token is expired or invalid, it auto-logs out.
 */
const AuthGuard = ({ children }: AuthGuardProps) => {
  ...
  // Verified — user object is now from the server, not localStorage
  if (!user) {
    return <Navigate to="/adminlogin" replace />;
  }
